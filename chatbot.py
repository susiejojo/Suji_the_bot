        ...
        if word.lower() in COMMAND_INPUTS:
            if (word in COMMAND_INPUTS[1]):
                if (flag1 == False):
                    ...
                    webbrowser.get().open(
                        "https://www.youtube.com/watch?v=G4I6PhHbH7o&list=RDG4I6PhHbH7o&start_radio=1")
                    #flag1 = True
                    time.sleep(5)
...
username = input()
nflag = 0
print("SUJI: Hello ,", username,
      ". I will remember to call you that. Go ahead...ask me something!")
while(flag == True):
    print(username, ": ", end="")
    user_response = input()
